...
const styles = StyleSheet.create({
  ...
  sendBtn: { minHeight: 44, justifyContent: 'center', backgroundColor: colors.forest, borderRadius: 8, paddingHorizontal: 18, paddingVertical: 12, marginBottom: 10 },
  sendBtnText: { color: '#fff', fontWeight: '500' },
  label: { fontSize: 12, color: colors.inkSoft, marginBottom: 4, marginTop: 6 },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 8 },
  chip: { minHeight: 44, justifyContent: 'center', borderWidth: 1, borderColor: colors.line, backgroundColor: '#fff', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 6 },
