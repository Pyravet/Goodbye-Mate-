...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    ...
    console.error('Client journey page crashed:', error, info?.componentStack);
  }
      ...
      return (
        <div style={styles.wrap}>
          <div style={styles.card}>
            ...
            <p style={styles.body}>This page hit an error. Please try reloading, or contact us directly if it keeps happening.</p>
