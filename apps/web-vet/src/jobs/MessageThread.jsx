    ...
    <div>
      <div ref={listRef} style={styles.list}>
        {loading ? (
          ...
          <p style={styles.empty}>No messages yet — anything you'd like to flag to admin before this visit?</p>
        ) : (
          messages.map((m) => {
...
const styles = {
  list: { display: 'flex', flexDirection: 'column', gap: 8, maxHeight: 300, overflowY: 'auto', marginBottom: 10, paddingRight: 2 },
  ...
  input: { flex: 1, padding: '10px 12px', borderRadius: 'var(--gm-radius-sm)', border: '1px solid var(--gm-line)', fontSize: 14 },
  sendBtn: { background: 'var(--gm-forest)', color: '#fff', border: 'none', borderRadius: 'var(--gm-radius-sm)', padding: '10px 16px', fontSize: 14, fontWeight: 500 },
};
